  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var negativeB = (-$uD(b$2.apply__O()));
        var twoA = (2 * $uD(a$2.apply__O()));
        var a$1 = $uD(delta$1.apply__O());
        var squareRootOfDelta = $uD($g.Math.pow(a$1, 0.5));
        var array = [((negativeB + squareRootOfDelta) / twoA), ((negativeB - squareRootOfDelta) / twoA)];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    var name = $as_T(x$1.$$und1$f);
    var exprSig = $as_Lcalculator_Signal(x$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, exprSig$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(exprSig$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, exprSig));
